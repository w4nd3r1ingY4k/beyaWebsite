    ...
    <div style={{ height: '100%', backgroundColor: '#FFFBFA', width: '100%' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
          <span style={{ fontSize: '14px', color: '#374151', fontWeight: 'bold' }}>Category:</span>
      ...
      <div style={{ display: 'flex', height: '88%' }}>
        {/* ─── New Inbox Button Column ─── */}
        {/* … above: “New Inbox Button Column” … */}
<div
  style={{
    minWidth: "80px",
...
>
  ...
  <button
    ...
    style={{
      ...
      margin: "4px 0",
      padding: "10px 0",
      background: viewFilter === "owned" ? "#EAE5E5" : "#fff",
      border: "1px solid #ddd",
      borderRadius: "6px",
      cursor: "pointer",
      fontSize: "14px",
  ...
  <button
    ...
    style={{
      ...
      margin: "4px 0",
      padding: "10px 0",
      background: viewFilter === "sharedWithMe" ? "#EAE5E5" : "#fff",
      border: "1px solid #ddd",
      borderRadius: "6px",
      cursor: "pointer",
      fontSize: "14px",
  ...
  <button
    ...
    style={{
      ...
      margin: "4px 0",
      padding: "10px 0",
      background: viewFilter === "sharedByMe" ? "#EAE5E5" : "#fff",
      border: "1px solid #ddd",
      borderRadius: "6px",
      cursor: "pointer",
      fontSize: "14px",
    ...
    Shared
        ...
        <div
          style={{
            ...
            flexDirection: 'column',
            backgroundColor: '#FBF7F7',
            marginBottom: 35, // Space for the reply overlay if it appears at the bottom
            width: 0,
            overflowX: 'hidden'
          }}
        >
