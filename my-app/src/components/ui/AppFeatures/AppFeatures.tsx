...
export function AppFeatures() {
  const settings = {
    ...
    autoplay: false,
    autoplaySpeed: 3000,
    slidesToShow: 1, // Matches your current single row layout for FeatureColumn groups
    slidesToScroll: 1,
    responsive: [
      {
        breakpoint: 1024,
        settings: {
          slidesToShow: 1, // Maintain single column layout
        },
      },
    ],
  };
  ...
  const icon1 = "https://cdn.builder.io/api/v1/image/assets/TEMP/43431b66f1f83d6e0e68bd91581ed9eebb56afa2d4fd0b6fefc47f6981a7e992?placeholderIfAbsent=true&apiKey=81df03e36d684043a7cd51a4520bc0ac";
  const icon2 = "https://cdn.builder.io/api/v1/image/assets/TEMP/9799e7e0a958388cd9bbe8d12744be0e3177ef5a2db06ddb5c4ba7bd2ffa30e3?placeholderIfAbsent=true&apiKey=81df03e36d684043a7cd51a4520bc0ac";
  const icon3 = "https://cdn.builder.io/api/v1/image/assets/TEMP/e7ef7a3eea63044cc9602cbdeaa294f78423bbfe2a63527dfa30b82893d993bc?placeholderIfAbsent=true&apiKey=81df03e36d684043a7cd51a4520bc0ac";
  const icon4 = "https://cdn.builder.io/api/v1/image/assets/TEMP/ec499e41ff62426332adb53d41da9d0b76e1a56ea1039f8342c9b3af5d1b65c2?placeholderIfAbsent=true&apiKey=81df03e36d684043a7cd51a4520bc0ac";


  const slides: {
    columns: { position: "left" | "center" | "right"; features: any[] }[];
  }[] = [
    // Signup Slide
    {
      columns: [
    ...
    // Profiles Slide
    {
      columns: [
        ...
        },
        {
          ...
          features: [
            {
              centerImage: "assets/profile.png",
            },
          ],
        },
        {
    ...
    },
    {
      ...
      columns: [
        ...
        },
        {
          ...
          features: [
            {
              centerImage: "assets/landing_page/features_image.png",
            },
          ],
        },
        {
    ...
    // Locales and Events Slide
    {
      columns: [
        ...
        },
        {
          ...
          features: [
            {
              centerImage: ["assets/locales.png", "assets/events.png"],
            },
          ],
        },
        {
    ...
    // Teams Page 
    {
      columns: [
        ...
        },
        {
          ...
          features: [
            {
              centerImage: ["assets/teams.png", "assets/teams2.png"],
            },
          ],
        },
        {
    ...
    // Checkout Slide
    {
      columns: [
        ...
        },
        {
          ...
          features: [
            {
              centerImage: ["assets/checkout.png", "assets/checkout2.png"],
            },
          ],
        },
        {
